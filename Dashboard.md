# Template Dashboard Bootstrap 5

1. Ini kode HTML nya dari Dashboard yang sudah di atur
```html
    <!doctype html>
...
```
  ...
  - Bila pakai partials bisa dibagi menjadi 3 bagian. Main, Sidebar, Header.
...
4. Untuk Route pada Web.php nya seperti ini jadinya.
   ...
   ```
5. Menambahkan isi dari konten My Artikel.
   - Disini ada beberapa konten dengan tabel yang di looping dengan foreach
   - dan ada Judul, Nama Kategori, dan Aksi.
